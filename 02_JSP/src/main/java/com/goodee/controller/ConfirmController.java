...
public class ConfirmController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 * 
		 * 2) 요청시 전달값(parameter) 추출 및 데이터 가공처리(피싱 등) => 변수 및 객체에 담기
		...
		//체크박스 형식이라 선택 안할수도 있어서 null값을 넣어줘야함.
		if(topping != null) {
		...
		//request.getRequestDispatcher("/WEB-INF/views/pizzaPayment.jsp").forward(request, response);
