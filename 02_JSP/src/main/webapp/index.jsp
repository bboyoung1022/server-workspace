...
<body>
	...
	<ol>
		<li>
			<!--&lt;, &gt; = <> 모양
			WEB-INF안의 파일은 외부에서 접근이 안되서 접근을 위해서는 forward해서 넘어가야함-->
			선언문 : &lt;%! 자바코드 %&gt; <br>
			멤버변수와 메소드 정의시 사용
		</li>
		<li>
		...
		<ol>
			<li>
				page 지시어 : 현재 jsp페이지를 처리하는데 필요한 각종 속성들을 기술<br>
				 ...
				 - pageEncoding : jsp페이지 내에 기록된 자바코드의 인코딩 방식 지정<br>
				 - import : 자바에서의 import와 동일<br>
				 - errorPage : 해당 jsp에서 오류 발생시 보여줄 에러페이지 경로 지정<br>
				 
				 <a href="/02_JSP/jsp/directive">지시어(Directive)</a>
			</li>
			<li>
				include 지시어 : 현재 jsp내에 또다른 jsp를 포함시키고자 할때 사용하는 지시어<br>
